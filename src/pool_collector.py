        ...
        for combination in token_combinations:
            ...
            new_pair = {
                ...
                'token0': {
                    ...
                    'latestUSDPrice': token0['token']['latestUSDPrice'],
                },
                'token1': {
                    'id': token1['address'],
                    'symbol': token1['symbol'],
                    ...
                    'latestUSDPrice': token1['token']['latestUSDPrice'],
                },
                'reserveUSD': token0['token']['totalBalanceUSD'] + token1['token']['totalBalanceUSD'],
